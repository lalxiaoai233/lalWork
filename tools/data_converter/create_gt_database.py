...
def create_groundtruth_database(
    ...
    # Check if database files already exist, skip processing if they do
    if osp.exists(db_info_save_path) and osp.exists(database_save_path):
        # Check if database directory is not empty
        import os
        if os.listdir(database_save_path):
            print(f'Database files already exist: {db_info_save_path}, {database_save_path}, skipping...')
            return
