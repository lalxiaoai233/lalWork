    ...
    def __call__(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.is_train:
            ...
            if "radar" in data:
                ...
                if hasattr(radar_obj, "rotate") and hasattr(radar_obj, "translate") and hasattr(radar_obj, "scale"):
                    radar_obj.rotate(-theta)
                    radar_obj.translate(translation)
                    radar_obj.scale(scale)
